...
import com.example.custofrete.domain.useCase.usuario.UsuarioVerificarUsuarioLogadoUseCase
...
val useCaseModule = module {
    ...
    factory { UsuarioVerificarUsuarioLogadoUseCase(usuarioRepository = get()) }
}
